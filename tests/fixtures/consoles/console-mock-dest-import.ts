...
Config.set('rc.commands.make:example.path', '#src/commands/MakeExampleCommand')
Config.set('rc.commands.make:example.destination', './tests/fixtures/storage/services')
